...
public class objective extends AppCompatActivity {
    ...
    String company_name,job,description,year,course,school,grade,eduction_year,name,email,phon,address,skill1,skill2,skill3,skill4,github,linkdin,objective;
    EditText edobjective;
    Button reset,next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edobjective = findViewById(R.id.edobjective);
